    ...
    if ([annotation isKindOfClass:[wiwAnnotation class]]) {
        ...
        if (!pinView1)
        {
            ...
            CGSize maxSize = CGRectInset(self.view.bounds,
                                         [NameViewController annotationPadding],
                                         [NameViewController annotationPadding]).size;
            maxSize.height -= self.navigationController.navigationBar.frame.size.height + [NameViewController calloutHeight];
