...
@interface TellHCMainViewController () {
    NSTimer *timer;
    NSTimer *timer1;
    NSMutableArray *json;
...
@implementation TellHCMainViewController
...
{
    [super viewDidLoad];
    self.navigationItem.title = @"tell HoCo";
...
- (void)openTutorial
{
    ...
    webVC.urlItem = @"http://www.youtube.com/embed/UskwWV4Wsnc";
...
- (IBAction)startButton:(id)sender {
    HomeViewController *tellHCVC = [[HomeViewController alloc]init];
    ...
    [[self navigationController]pushViewController:tellHCVC animated:YES];
}
@end
